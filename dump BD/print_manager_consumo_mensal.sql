...
--
-- Table structure for table `consumo_mensal`
--
...
CREATE TABLE `consumo_mensal` (
  ...
  `custo_estimado` decimal(12,4) NOT NULL DEFAULT '0.0000',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
  UNIQUE KEY `consumo_usuario_mes_uq` (`usuario_id`,`mes_ano`),
  CONSTRAINT `fk_consumo_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `consumo_mensal`
--

LOCK TABLES `consumo_mensal` WRITE;
/*!40000 ALTER TABLE `consumo_mensal` DISABLE KEYS */;
/*!40000 ALTER TABLE `consumo_mensal` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-27  2:35:47
