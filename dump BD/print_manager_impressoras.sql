...
CREATE TABLE `impressoras` (
  ...
  `ip_rede` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo` enum('central','balcao') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'balcao',
  `ativo` tinyint(1) NOT NULL DEFAULT '1',
  `ultimo_heartbeat` datetime(3) DEFAULT NULL,
