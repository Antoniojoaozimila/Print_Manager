...
const PATHS = {
  ...
  ticket: (
    <path d="M20 12a2 2 0 012-2V6a2 2 0 00-2-2H4a2 2 0 00-2 2v4a2 2 0 012 2 2 2 0 01-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 01-2-2zm-3.5-1.09V7.5H7.5v3.41A3.49 3.49 0 019 14a3.49 3.49 0 01-1.5 2.91V18.5h9v-1.59A3.49 3.49 0 0115 14a3.49 3.49 0 011.5-3.09z" />
  ),
  close: (
